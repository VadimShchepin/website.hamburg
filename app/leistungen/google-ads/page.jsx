...
export const metadata = {
    ...
    description: 'Professionelles Google Ads Management fur lokale Unternehmen in Hamburg. Search Ads, Local Services Ads, Conversion Tracking, ROI-Optimierung. Ab 500 Euro/Mt.',
    alternates: {
