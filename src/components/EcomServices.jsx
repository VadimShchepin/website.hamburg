...
const SERVICES = [
    {
        ...
        short: 'Wir wählen gemeinsam das passende System und planen den Shop, bevor jemand Code schreibt.',
        detail: 'Bevor gebaut wird, klären wir die Grundlagen. Welches System passt zu Ihrem Sortiment und Ihren Plänen? Wo verlieren Sie heute Umsatz? Ich schaue mir Markt und Wettbewerb an und gebe eine ehrliche Empfehlung. An Lizenzen verdiene ich nichts, also rate ich zu dem, was für Sie funktioniert.',
    ...
    },
    {
        ...
        detail: 'Ich baue den Shop von Grund auf oder ziehe Ihren bestehenden auf ein neues System um, ohne dass Bestellungen oder Google-Rankings verloren gehen. Tempo steht dabei im Mittelpunkt: schnelle Ladezeiten und grüne Core Web Vitals, weil langsame Shops Käufer kosten.',
    ...
    },
    {
        ...
        short: 'Ihr Shop steht schon? Ich mache ihn schneller, größer und verkaufsstärker.',
        detail: 'Nicht jedes Projekt braucht einen Relaunch. Oft reicht es, an den richtigen Stellen anzusetzen: neue Funktionen, mehr Tempo, ein besserer Checkout. Ich starte mit einem Blick auf den Ist-Zustand und sage Ihnen ehrlich, was sich lohnt.',
    ...
    },
    {
        ...
        short: 'Ich verbinde Ihren Shop mit den Systemen, mit denen Sie ohnehin arbeiten.',
        detail: 'Ein Shop steht selten allein. Ich binde ihn an Ihre Warenwirtschaft, Buchhaltung und Versanddienstleister an und spiele Ihre Produkte auf Marktplätzen aus. So fließen Daten automatisch dorthin, wo sie gebraucht werden.',
    ...
    },
    {
        ...
        detail: 'Gute Produkte verkaufen sich nicht von selbst, wenn die Texte nicht stimmen. Sie bekommen Produkt- und Kategorietexte, die Käufer überzeugen und gleichzeitig zu dem passen, wonach Menschen wirklich suchen. Auch bei großen Sortimenten bleibt das konsistent.',
    ...
    },
    {
        ...
        short: 'Ein fertiger Shop ist der Anfang. Danach sorge ich für Besucher und Käufer.',
        detail: 'Damit aus dem Shop Umsatz wird, braucht es Reichweite. Ich kümmere mich um SEO und Google Ads, halte Ihre Produktdaten im Merchant Center sauber und arbeite daran, mehr Besucher zu Käufern zu machen. Was funktioniert, sehen Sie im monatlichen Reporting.',
