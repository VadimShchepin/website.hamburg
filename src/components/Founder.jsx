        ...
        <section id="founder" className="founder section">
            <div className="container">
                <div className="founder-layout">
                    <div className="founder-photo animate-up">
                        <Image
                            src="/referenzen/vadim_shchepin_2.webp"
                            alt="Vadim Shchepin, Webentwickler und Gründer von webseite.hamburg"
                            width={480}
                            height={640}
                            quality={85}
                        />
                    ...
                    <div className="founder-text">
                        ...
                        <div className="founder-links animate-up">
                            <a href="https://www.linkedin.com/in/vadim-shchepin/" target="_blank" rel="noopener noreferrer" className="founder-link" data-umami-event="founder-linkedin">
