...
export const metadata = {
    title: 'AI SEO Hamburg | Sichtbar in ChatGPT & Perplexity',
    description: 'AI SEO Optimierung fur Sichtbarkeit in ChatGPT, Perplexity und Google AI Overviews. Ihr Unternehmen als vertrauenswurdige Quelle in KI-Antworten. Ab 1.200 Euro/Mt.',
    alternates: {
