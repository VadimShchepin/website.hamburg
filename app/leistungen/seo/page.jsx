...
export const metadata = {
    ...
    description: 'Professionelle Suchmaschinenoptimierung fur lokale Unternehmen in Hamburg. Google Rankings, lokale Sichtbarkeit, Google Maps Optimierung. Ab 1.000 Euro/Mt.',
    alternates: {
