...
export const metadata = {
    ...
    description: 'Kostenlose Website-Analyse: Performance, SEO, Struktur und Conversion-Potenzial. Ehrliche Einschatzung mit konkreten Handlungsempfehlungen fur Ihr Unternehmen.',
    alternates: {
