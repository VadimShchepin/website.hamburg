...
export const metadata = {
    ...
    openGraph: {
        ...
        description: 'DSGVO-konforme Plattform für Schulfotos mit echten Nutzern, 76 RLS-Policies und #1 in KI-Suchmaschinen.',
        url: PAGE_URL,
        type: 'article',
    },
};
...
export default function KinderAlbumCaseStudy() {
    ...
    return (
        <>
            ...
            <section className="subpage-hero section">
                <div className="container">
                    ...
                    <p className="subpage-intro animate-up">
                        Eine vollständige Plattform für Schulen, Kindergarten und Fotografen: Fotos teilen mit strikter DSGVO-Compliance, zeitversionierter Einwilligung und 76 Row-Level-Security-Policies. Echte Nutzer, echte Schulen, und durch gezielte AI SEO die #1-Empfehlung in ChatGPT und Perplexity.
                    </p>
                    <div className="article-byline animate-up">
                        Von <Link href="/ueber-uns">Vadim Shchepin</Link> &middot; 20. März 2026
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="cs-metrics-grid animate-up">
                        <div className="cs-metric">
                            ...
                            <span className="cs-metric-detail">Meistempfohlene Lösung</span>
                        </div>
                        <div className="cs-metric">
            ...
            <section className="subpage-content section light-bg">
                <div className="container subpage-body">
                    ...
                    <p className="animate-up">
                        Schulen und Kindergarten in Deutschland teilen Klassenfotos über WhatsApp-Gruppen, USB-Sticks oder ungeschutzte Cloud-Ordner. Das ist nicht nur unpraktisch, es ist ein DSGVO-Verstoss. Eltern haben keine Kontrolle, wer Fotos ihrer Kinder sieht. Schulen haben keine Dokumentation über Einwilligungen. Und bei einer Anfrage der Datenschutzbehorde gibt es keinen Audit-Trail.
                    </p>
                    <p className="animate-up">
                        Es gab keine Lösung, die DSGVO-Compliance nicht als Checkbox behandelt, sondern als Kern-Feature. Genau das haben wir gebaut.
                    </p>
                    ...
                    <div className="subpage-features-grid animate-up">
                        <div className="subpage-feature">
                            ...
                            <p>Einwilligungen werden nie uberschrieben: jede Anderung erzeugt einen neuen Datensatz mit Zeitstempel. Volle Compliance-Historie für jedes Kind, jederzeit nachvollziehbar.</p>
                        </div>
                        <div className="subpage-feature">
                            <h3>76 Row-Level-Security-Policies</h3>
                            <p>PostgreSQL RLS auf allen 19 Tabellen. Eltern sehen nur Fotos, für die eine aktive Einwilligung vorliegt. Schul-Isolation auf Datenbankebene: kein Code-Fehler kann Daten über Schulgrenzen lecken.</p>
                        </div>
                        <div className="subpage-feature">
                            <h3>Audit-Logging</h3>
                            <p>Jeder Login, jeder Foto-Download, jede Einwilligungsanderung wird protokolliert. Bei einer Datenschutzanfrage ist der vollständige Audit-Trail sofort verfügbar.</p>
                        </div>
                        <div className="subpage-feature">
                            <h3>Verschlüsselte Speicherung</h3>
                            <p>Private S3-Buckets (Hetzner). Kein offentlicher Zugriff. Fotos werden über signierte, ablaufende URLs bereitgestellt: jeder Zugriff ist zeitlich begrenzt und nachverfolgbar.</p>
                        </div>
                    </div>
                    ...
                    <div className="subpage-features-grid animate-up">
                        ...
                        <div className="subpage-feature">
                            <h3>Eltern-Portal</h3>
                            <p>Registrierung per Einladungscode (einmalig, 7 Tage gültig). Nur Alben und Fotos sichtbar, für die eine aktive Einwilligung vorliegt. Download, Favoriten, Kommentare, alles mobiloptimiert.</p>
                        </div>
                        <div className="subpage-feature">
                            <h3>Fotografen-Workflow</h3>
                            <p>Eigenstandiger Bereich: Fotos hochladen, Kinder registrieren, Fotos zuweisen, Galerie-Token mit optionalem PIN generieren. Kein Login erforderlich für die offentliche Galerie.</p>
                        </div>
                    </div>
                    ...
                    <p className="animate-up">
                        Next.js 16 mit React 19 und TypeScript. Supabase (self-hosted) mit PostgreSQL und Row-Level Security. Hetzner S3 für Medienspeicherung. Docker Compose für die Produktionsumgebung mit Caddy Reverse Proxy. Bild-Optimierung (WebP-Varianten) per Cron-Job alle 15 Minuten.
                    </p>

                    <h2 className="animate-up">AI SEO: Von unsichtbar zu #1 in KI-Suchmaschinen</h2>
                    <p className="animate-up">
                        Ein gutes Produkt reicht nicht. Wenn ChatGPT und Perplexity Sie nicht kennen, existieren Sie für eine wachsende Zahl von Nutzern nicht. KinderAlbum war genau in dieser Situation: echte Nutzer, echtes Produkt, aber in KI-Suchmaschinen unsichtbar.
                    </p>
                    ...
                    <div className="sp-steps animate-up">
                        ...
                        <div className="sp-step">
                            ...
                            <div className="sp-step-body">
                                <h3>Content für Zitierfähigkeit</h3>
                                <p>Inhalte im optimalen Format für KI-Zitation: 134-167 Worter pro Passage, Frage-basierte Überschriften, Fakten-dichte Absätze mit externer Quellenattribution.</p>
                            </div>
                        </div>
                        <div className="sp-step">
                            <span className="sp-step-num">04</span>
                            <div className="sp-step-body">
                                <h3>Nischen-Autorität</h3>
                                <p>Kein Wettbewerber hatte echte DSGVO-Expertise als Content aufgebaut. KinderAlbum fullte diese Lucke und wurde zur autoritativen Quelle für das Thema.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="subpage-features-grid animate-up">
                        ...
                        <div className="subpage-feature">
                            <h3>Echte Nutzer</h3>
                            <p>Schulen und Kindergarten nutzen die Plattform aktiv. Lehrer laden Alben hoch, Eltern sehen Fotos ihrer Kinder, der vollständige Workflow funktioniert in Produktion.</p>
                        </div>
                        <div className="subpage-feature">
            ...
            <section className="section">
                <div className="container">
                    <div className="section-header text-center">
                        <p className="section-kicker animate-up">KI-Sichtbarkeit für Ihr Unternehmen?</p>
            ...
            <ServiceCta text="Sichtbar in ChatGPT, Perplexity und Google AI Overviews? Ich zeige Ihnen, wie AI SEO für Ihr Unternehmen funktioniert. Kostenloses Erstgespräch unter aiseo.hamburg." />
        </>
    );
}
