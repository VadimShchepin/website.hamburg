...
export const metadata = {
    ...
    description: 'Architektur-Case-Study von dsgvoschulfotos.de: QR-Code + PIN statt Accounts, Row Level Security, signierte URLs — und der Performance-Preis: 723 imgproxy-Fehler in 72 Stunden, bis vorgenerierte WebP-Varianten kamen.',
    alternates: {
    ...
    openGraph: {
        ...
        description: 'QR-Code + PIN statt Accounts, Row Level Security, signierte URLs — und der Performance-Preis: 723 imgproxy-Fehler in 72 Stunden, bis vorgenerierte WebP-Varianten kamen.',
...
const faqItems = [
    ...
    },
    {
        ...
        a: 'Indirekt ja, auf zwei Wegen: Erstens kostet jede Signierung einen internen HTTP-Request — bei Einzelsignierung pro Foto entsteht ein N+1-Problem. Zweitens wird das Ablauf-Token bei jedem Seitenaufruf neu generiert, wodurch Browser- und CDN-Cache strukturell leerlaufen: identisches Bild, anderer URL-String, erneuter Download.',
    },
];
            ...
            >
                ...
                <ul>
                    <li>
                        ...
                        dieselbe Codebasis, dieselbe Falle — zweimal.
                    </li>
                    <li>
                        ...
                        die Varianten komplett — dasselbe Problem, durch die Hintertür wieder eingebaut.
                    </li>
                    <li>
                ...
                <ul>
                    <li><strong>Privater Storage?</strong> Dann Bildvarianten beim Upload vorgenerieren — Echtzeit-Transformationen sind ein Ausfall mit Ansage.</li>
