...
const faqCategories = [
    {
        ...
        questions: [
            { q: 'Was kostet eine professionelle Website?', a: 'Eine Conversion Landingpage (One-Pager) beginnt ab 2.900 Euro, eine mehrseitige Unternehmenswebsite ab 4.500 Euro. Der finale Preis haengt von Umfang, Funktionen und individuellen Anforderungen ab. Im kostenlosen Erstgesprach erhalten Sie eine konkrete Einschaetzung.' },
            { q: 'Wie lange dauert die Erstellung einer Website?', a: 'Eine Landingpage ist typischerweise in 2-3 Wochen fertig, eine mehrseitige Website in 4-6 Wochen. Die genaue Dauer haengt von Ihrem Feedback-Tempo und dem Umfang des Projekts ab.' },
            ...
            { q: 'Was passiert nach dem Launch der Website?', a: 'Sie erhalten volle Zugaenge zu allen Konten und Daten. Bei Bedarf biete ich laufende Betreuung, SEO-Optimierung oder Google Ads Management an. Es gibt keinen Lock-in, alles gehoert Ihnen.' },
            { q: 'Kann ich meine Website selbst bearbeiten?', a: 'Ja, wenn gewuenscht integriere ich ein CMS (Content Management System), mit dem Sie Texte, Bilder und Seiten selbst aendern koennen. Fuer rein statische Seiten uebernehme ich Aenderungen schnell und unkompliziert.' },
        ],
    },
    {
    ...
    },
    {
        ...
        questions: [
            ...
            { q: 'Was kostet AI SEO?', a: 'Der Einstieg ist ein einmaliger AI Visibility Sprint ab 1.500 Euro: Analyse, Optimierung Ihrer wichtigsten Seiten, strukturierte Daten, Crawler-Konfiguration und eine Messung vorher und nachher, mit Ergebnis in 10 bis 14 Tagen. Eine laufende Betreuung mit Monitoring und neuen Inhalten gibt es danach optional ab 600 Euro pro Monat, monatlich kuendbar.' },
        ],
    },
    {
        name: 'Google Ads',
        questions: [
            { q: 'Was kostet Google Ads Management?', a: 'Das Kampagnen-Setup kostet ab 700 Euro einmalig, die laufende Betreuung ab 500 Euro pro Monat. Das Werbebudget kommt separat dazu und laeuft ueber Ihr eigenes Google-Konto. Ich empfehle ein Mindestbudget von 500 Euro pro Monat fuer messbare Ergebnisse.' },
    ...
    },
    {
        ...
        questions: [
            ...
            { q: 'Sind Sie eine Agentur oder ein Einzelunternehmer?', a: 'Hinter AISEO steht Vadim Shchepin als Einzelunternehmer, kein Agentur-Netzwerk. Sie arbeiten direkt mit mir: Ich mache die Analyse, baue die Website, betreue SEO und Ads. Braucht ein Projekt zusaetzliche Expertise, etwa bei Design, Text oder Fotografie, hole ich gepruefte Spezialisten dazu. Ihr Ansprechpartner und der Verantwortliche fuer das Ergebnis bleibe ich.' },
